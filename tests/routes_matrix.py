...
FROZEN_ROUTES: list[tuple[str, str]] = [
    ...
    ("DELETE", "/v1/users/me/resource-organization/favorites/:resource_type/:resource_id"),
    ("DELETE", "/v1/users/me/resource-organization/folders/:folder_id"),
    ("DELETE", "/v1/users/me/resource-organization/folders/:folder_id/resources/:resource_type/:resource_id"),
    ("DELETE", "/v1/workspaces/:id/apps/:app_id"),
    ("DELETE", "/v1/workspaces/:id/databases/:db_id"),
    ("DELETE", "/v1/workspaces/:id/members/:user_id"),
    ("DELETE", "/v1/workspaces/:id/resource-organization/favorites/:resource_type/:resource_id"),
    ("DELETE", "/v1/workspaces/:id/resource-organization/folders/:folder_id"),
    ("DELETE", "/v1/workspaces/:id/resource-organization/folders/:folder_id/resources/:resource_type/:resource_id"),
    ...
    ("PATCH", "/v1/users/me"),
    ("PATCH", "/v1/users/me/resource-organization/folders/:folder_id"),
    ("PATCH", "/v1/workspaces/:id/resource-organization/folders/:folder_id"),
    ("POST", "/v1/apps"),
    ...
    ("POST", "/v1/users/me/resource-organization/folders"),
    ("POST", "/v1/workspaces"),
    ("POST", "/v1/workspaces/:id/apps/:app_id"),
    ("POST", "/v1/workspaces/:id/databases/:db_id"),
    ("POST", "/v1/workspaces/:id/resource-organization/folders"),
    ("POST", "/v1/workspaces/:id/roles"),
    ("PUT", "/v1/apps/:id/files"),
    ("PUT", "/v1/databases/:id"),
    ("PUT", "/v1/users/me/resource-organization/favorites/:resource_type/:resource_id"),
    ("PUT", "/v1/users/me/resource-organization/folders/:folder_id/resources/:resource_type/:resource_id"),
    ("PUT", "/v1/workspaces/:id"),
    ("PUT", "/v1/workspaces/:id/members/:user_id"),
    ("PUT", "/v1/workspaces/:id/resource-organization/favorites/:resource_type/:resource_id"),
    ("PUT", "/v1/workspaces/:id/resource-organization/folders/:folder_id/resources/:resource_type/:resource_id"),
